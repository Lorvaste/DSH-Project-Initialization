...
- 模板体系：alignment/doc-templates（20 份）+ alignment/rule-templates（8 份），zh/en 双版
...
- 2026-09-01：按 skill 规则整理——与实装模板核对一致（结构定义以 core-library/presets/alignment 内模板为准）
- 2026-09-01：v1.1 发布前——场景化标题改阶段化（生成项目生命周期阶段，非插件场景）；模板数量 16/7 → 20/8
